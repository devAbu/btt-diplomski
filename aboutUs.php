...
<body>
    ...
    <nav class="navbar bg-primary navbar-dark navbar-expand-md fixed-top" style="opacity:0.7; font-size:18px !important;">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav" id="navScrollspy">
                ...
                <li class="nav-item">
                    <a href="aboutUs.php" class="nav-link link active">
